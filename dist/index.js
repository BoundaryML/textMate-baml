...
const grammar = {
  ...
  "patterns": [
    ...
    {
      "include": "#member-fragment"
    },
    {
      "include": "#type-fragment"
    }
  ],
  "repository": {
    "accessor-dot": {
    ...
    "member-fragment": {
      "name": "meta.member-fragment.baml",
    ...
    "type-fragment": {
      "name": "meta.type-fragment.baml",
      "begin": "^\\s*(?=\\$?[A-Za-z_][A-Za-z0-9_-]*(?:\\$[A-Za-z_][A-Za-z0-9_-]*)*)(?=[^:=;{}()#\"'\\r\\n]*$)(?=[^<.\\[?|\\r\\n]*[<.\\[?|]|(?:(?:int|float|bigint|string|bool|image|audio|map|json|unknown|never|Self))\\s*$)",
      "end": "$",
      "patterns": [
        {
          "include": "#comments"
